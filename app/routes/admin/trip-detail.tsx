...
const tripDetail = ({ loaderData }: Route.ComponentProps) => {
    ...
    const destination = tripData.location.city + ', ' + tripData.country;
    ...
    return (
        <main className="travel-detail wrapper">
            <section className="container wrapper-md">
                ...
                <section className="title">
                    <article>
                        ...
                        <p>
                            {budget}, {interests} - {groupType} Trip 
                        </p>
                    </article>
                        ...
                        <li key={index}>
                            ...
                            <ul>
                                {dayPlan.activities.map((activity, index: number) => (
                                    <li key={index}>
                                        <span className="flex-shring-0 font-semibold">{activity.time}</span>
            ...
            <section className="flex flex-col gap-6">
                <h2 className="p-24-semibold text-dark-100">Popoular Trips</h2>
