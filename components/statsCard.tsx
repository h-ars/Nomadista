        ...
        <div className="content">
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <p className='text-sm font-medium text-gray-100 truncate'>v/s last month</p>
                </div>
            </div>
            <img src={`/assets/icons/${isDecrement ? 'decrement.svg' : 'increment.svg'}`} alt="trendChart" className='xl:w-32 w-full sm:h-6 h-full md:h-32 xl:h-full'/>
        </div>
    </article>
  )
}
